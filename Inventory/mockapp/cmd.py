...
from mockapp.utils import trycopytree
from mockapp.utils import trycopy
from mockapp.utils import trymkdir
from mockapp.utils import trymkfile
from mockapp.uploads import add_admin
from mockapp.uploads import add_setting
...
def new_project(path, newfoldername):
    ...
    trycopytree("./mockapp", base_path + "/mockapp")
...
def clean():
    if os.path.exists("mockapp.db"):
        os.remove("mockapp.db")
        print("mockapp.db successfully deleted")
    else:
        print("mockapp.db doesn't exist")
